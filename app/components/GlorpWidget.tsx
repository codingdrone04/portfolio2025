...
export default function GlorpWidget() {
	...
	const [currentGlorpIndex, setCurrentGlorpIndex] = useState<number | null>(
		null,
	);
	...
	return (
		<div
			className="hidden md:block absolute bottom-2 right-4 z-10"
			role="complementary"
			aria-label="Glorp Generator Widget"
		>
			<div
				className={`relative ${currentGlorpIndex === null && !isGenerating ? "animate-bounce" : ""}`}
			>
					...
					>
						<Image
							...
							style={{
								...
								objectFit: "contain",
								animation: isVisible
									? "fadeInBounce 0.5s ease-in forwards"
									: "none",
							}}
							unoptimized
						/>
